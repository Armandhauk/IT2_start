...
lag_med_flest_seriemesterskap = eliteserielag[0]

for lag in eliteserielag:
    if len(lag["seriemesterskap"]) > len(lag_med_flest_seriemesterskap["seriemesterskap"]):
        lag_med_flest_seriemesterskap = lag

print(f"Laget med flest seriemesterskap er {lag_med_flest_seriemesterskap['lag']}, med {len(lag_med_flest_seriemesterskap['seriemesterskap'])} seriemesterskap.")
